    ...
    def test_native_fault_manifest_is_fail_closed_for_review(self):
        with tempfile.TemporaryDirectory(prefix="fs2-native-fault-manifest-") as directory:
            ...
            manifest = {
                ...
                "target": "x86_64-pc-windows-msvc",
            "requested_toolchain": "1.97.1",
                "resolved_toolchain": "rustc 1.97.1\nrelease: 1.97.1\nLLVM version: 22.1.6\nhost: x86_64-pc-windows-msvc",
                "test_id": "windows::test::records_os_mediated_native_failures",
            "command": ["cargo", "+1.97.1", "test", "--package", "fs2", "--lib", "--target", "x86_64-pc-windows-msvc", "--locked", "windows::test::records_os_mediated_native_failures", "--", "--exact", "--test-threads=1", "--nocapture"],
    ...
    def test_appverifier_indeterminate_manifest_retains_preflight_reason(self):
        with tempfile.TemporaryDirectory(prefix="fs2-appverifier-manifest-") as directory:
            ...
            "requested_toolchain": "1.97.1",
                ...
                "commands": {
                    "build": ["cargo", "+1.97.1", "test", "--package", "fs2", "--target", "x86_64-pc-windows-msvc", "--locked", "--test", "windows_appverifier", "--no-run", "--message-format=json"],
