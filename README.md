...
requires Rust stable 1.88.0 or greater.
 ...
 * Dependency modernization
   ...
   - Updated to Rust 1.88.0 and Rust 2024 edition syntax
...
and Windows with Rust 1.88.0 (MSRV) and Rust 1.97.1. The historical 32-bit and GNU
